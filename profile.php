	      ...
	      <section class="content">
	        <div class="row">
	        	<div class="col-sm-9">
	        		...
	        		?>
	        		<div id="user-details-box" class="box box-solid">
	        			<div class="box-body">
	        				<div class="col-sm-3">
	        		...
	        		<div id="transaction-history-box" class="box box-solid">
	        			<div class="box-header with-border">
	        				<h4 style="color: white;" class="box-title"><i class="fa fa-calendar"></i> <b>Transaction History</b></h4>
	        			</div>
	        			<div class="box-body">
